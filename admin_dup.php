...
::placeholder {
	...
	body{
		background-image: url("anits_img.jpg");
...
<body>
  ...
  <li><font size="6px"><a href="admin_dup.html">ADMIN</a></font></li>
...
<span><img src="eyeicon.png" onmouseover="mouseoverPass();" onmouseout="mouseoutPass();"></span>
	<button type="submit" class="button"><font size="4" color="black">Sign In</font></button>
</div>
</form>
<script> 
